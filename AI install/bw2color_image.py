...
# import the necessapipry packages
import numpy as np
import argparse
import cv2
import urllib
...
uri = 'https://cdn.cambridgeincolour.com/images/tutorials/bw_parrot-green.jpg'
#from urllib.parse import urlparse
#parse_object = urlparse(uri)
#from posixpath import basename, dirname
#imgname = basename(parse_object.path)

#print (imgname)
image = urllib.urlretrieve(uri,"00000002.jpg")
...
cv2.imwrite("00000002bw.jpg",colorized)
cv2.waitKey(0)